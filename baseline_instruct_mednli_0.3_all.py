...
import os
import shutil
experiment_name='instruct_baseline_mednli_3.1_rate_0.3'
...
initial_model_path='/dccstor/obsidian_llm/yiduo/copy_v2/finetuned_models/MedNLImednli_baseline_12_20001e-6_model' #GSM8kbaseline_random_2_20001e-6_model' #GSM8kgsm_baseline_10_20001e-6_model' #'/dccstor/obsidian_llm/yiduo/copy_v2/finetuned_models/GSM8kbaseline_random_2_40001e-6_model'
initial_data_path='dataset_MedNLI_2000mednli_baseline_12' #'dataset_GSM8k_2000baseline_random_2' #dataset_GSM8k_4000baseline_random_2' #'dataset_LogiQA_3000baseline_logiqa'
learning_rate=1e-6
# Configure logging
logging.basicConfig(
    filename="{0}.log".format(experiment_name), 
...
#            pdb.set_trace()
    ...
    try:
        ...
        torch.save(win_paths,'mednli_win_paths.pt')
        pdb.set_trace()
