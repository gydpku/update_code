...
import os
import shutil
experiment_name='random_3k_baseline_select'
 ...
 #   pdb.set_trace()
    ...
    try:
        ...
        for model_path in model_paths:
            ooa_failed_cases, im_failed_cases, correct_cases = process_nli_validation_batch_major(
                model_path,  # Was using global_best_model_path incorrectly
                valid_data,
                seed=False,
                iteration=100
            )
