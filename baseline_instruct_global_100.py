...
import os
import shutil
experiment_name='instruct_model_initial_data_global_100'
...
initial_data_path='dataset_MedNLI_4000baseline'
learning_rate=1e-6
# Configure logging
logging.basicConfig(
...
#        pdb.set_trace()
    ...
    for name in names:
        ...
        while not train_status_check(model_output_path):
            train_model(os.path.join(cur_path,'random_3k_'+name),base_model_path,model_output_path,seed=train_seed,learning_rate=learning_rate)
