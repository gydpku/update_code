...
import os
import shutil
experiment_name='instruct_baseline_mednli_base'
...
initial_model_path='/dccstor/obsidian_llm/yiduo/copy_v2/finetuned_models/MedNLIbaseline_40001e-6_model'
initial_data_path='dataset_MedNLI_4000baseline' #'dataset_GSM8k_3000baseline_random_2' #'dataset_LogiQA_3000baseline_logiqa'
learning_rate=1e-6
# Configure logging
logging.basicConfig(
    filename="{0}.log".format(experiment_name), 
...
#        pdb.set_trace()
    ...
    global_data_count=process_validation_batch_count(initial_model_path, global_best_data,task=task_name,seed=False, iteration=100)
