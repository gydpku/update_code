...
def collect_simple_solutions(a1_prompts_answers, a2_prompts_answers, a3_prompts_answers, model, tokenizer, solution_nums=32, temperature=0.2):
    ...
    for data in a1_prompts_answers:
        prompt = data['Input']
        other_data_points = ['Input:'+d[0]+'\nOutput:'+d[1] for d in data_solutions if d[0] != data['Input']] #other_data_points = ['Input:'+d['Input']+'\nOutput:'+data['COT_Output'] for d in data_solutions if d[0] != data['Input']]
    ...
    for data in a2_prompts_answers:
        prompt = data['Input']
        other_data_points = ['Input:'+d[0]+'\nOutput:'+d[1] for d in data_solutions if d[0] != data['Input']] #other_data_points = ['Input:'+d['Input']+'\nOutput:'+data['COT_Output'] for d in data_solutions if d[0] != data['Input']] #other_data_points = ['Input:'+d['Input']+'\nOutput:'+data['COT_Output'] for d in a2_prompts_answers if d != data]
    ...
    for data in a3_prompts_answers:
        prompt = data['Input']
        other_data_points = ['Input:'+d[0]+'\nOutput:'+d[1] for d in data_solutions if d[0] != data['Input']]
...
if __name__ == "__main__":
    ...
    type='in_context_random_self_rewrite'
